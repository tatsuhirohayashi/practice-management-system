...
const navigation: NavigationItem[] = [
  {
    name: "予約済みレッスン",
    href: "/coach/lesson/reserved",
  },
  {
    name: "レッスン候補日時",
    href: "/coach/lesson/notreserved",
  },
  {
    name: "クライアント管理",
    href: "/coach/client",
...
interface CoachSidebarPresenterProps {
  pathname: string;
}

export function CoachSidebarPresenter({
  pathname,
}: CoachSidebarPresenterProps) {
  return (
    <>
      {/* サイドバー */}
